...
gh attestation verify --owner andrewlock "NetEscapades.AspNetCore.SecurityHeaders.TagHelpers.1.3.1.nupkg"
```

on success, this displays output similar to the following:

```bash
Loaded digest sha256:bf809ff0ed6a8a31131df4391b169e35ded44d4dfd97cc797123441683a95c9f for file://NetEscapades.AspNetCore.SecurityHeaders.1.3.1.nupkg
...
- Attestation #1
  ...
  - Build workflow:. .github/workflows/BuildAndPack.yml@refs/tags/v1.3.1
  - Signer repo:.... andrewlock/NetEscapades.AspNetCore.SecurityHeaders
  - Signer workflow: .github/workflows/BuildAndPack.yml@refs/tags/v1.3.1
```
...
gh attestation verify --owner andrewlock --predicate-type https://cyclonedx.org/bom "NetEscapades.AspNetCore.SecurityHeaders.TagHelpers.1.3.1``.nupkg"
```
