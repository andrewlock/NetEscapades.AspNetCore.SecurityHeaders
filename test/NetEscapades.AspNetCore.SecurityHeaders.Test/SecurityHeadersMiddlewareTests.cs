...
public class SecurityHeadersMiddlewareTests
{
    ...
    [Test]
    public async Task HttpRequest_CallingAddSecurityHeaderPoliciesWithoutLambdaTwice_OverwritesPolicies()
    {
        var policyName = "custom";
        ...
        using (var server = new TestServer(hostBuilder))
        {
            // default policy - not applied
            {
                ...
                response.Headers.Should().NotContainKey("Default-Header").And.NotContainKey("Custom-Header");
            }

            // custom policy - not applied
            {
            ...
            // selector policy, only applied header
            {
