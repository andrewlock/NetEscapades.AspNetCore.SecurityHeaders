...
public class CspBuilderTests
{
    ...
    {
        var builder = new CspBuilder();
        builder.AddDefaultSrc().Self().Blob().Data().From(new[] { "http://testUrl.com", "http://testUrl2.com" });
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddScriptSrc().Self().Blob().Data().From("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddScriptSrcElem().Self().Blob().Data().From("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddScriptSrc().Self().UnsafeEval().WasmUnsafeEval().UnsafeInline().StrictDynamic().ReportSample().WithNonce().From("http://testUrl.com");
        var result = builder.Build();
        result.Invoking(x => x.ConstantValue).Should().Throw<InvalidOperationException>();
    }
    ...
    public void Build_AddSrciptSrc_WhenDoesntAddNonce_BuilderThrowsInvalidOperation()
    {
        ...
        var result = builder.Build();
        result.Invoking(x => x.Builder).Should().Throw<InvalidOperationException>();
    }
    ...
    {
        var builder = new CspBuilder();
        builder.AddScriptSrc().Self().UnsafeEval().UnsafeInline().StrictDynamic().ReportSample().WithNonce().From("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddStyleSrc().Self().ReportSample().Blob().Data().From("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddStyleSrcElem().Self().ReportSample().Blob().Data().From("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddFrameAncestors().Self().Blob().Data().From(["http://testUrl.com", "https://testUrl.com"]);
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddSandbox().AllowDownloads().AllowForms().AllowModals();
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddSandbox().AllowTopNavigationToCustomProtocols();
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddDefaultSrc().Self().Blob().Data().From("http://testUrl.com").None();
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddReportUri().To("http://testUrl.com");
        var result = builder.Build();
    ...
    {
        var builder = new CspBuilder();
        builder.AddTrustedTypes().AllowPolicy("one").AllowPolicy("two").Default().AllowDuplicates();
        var result = builder.Build();
