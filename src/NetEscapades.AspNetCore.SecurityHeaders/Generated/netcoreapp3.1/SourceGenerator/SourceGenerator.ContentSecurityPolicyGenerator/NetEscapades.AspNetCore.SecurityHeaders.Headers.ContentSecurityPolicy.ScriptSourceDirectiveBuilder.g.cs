...
public partial class ScriptSourceDirectiveBuilder
{
    /// <summary>
    /// Block the resource (Refers to the empty set; that is, no URLs match)
    /// </summary>
    /// <returns>The builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder None()
    {
        BlockResources = true;
        return this;
    }
    ...
    public ScriptSourceDirectiveBuilder Self()
    {
        Sources.Add("'self'");
        return this;
    }
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder From(string uri)
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder From(System.Collections.Generic.IEnumerable<string> uris)
    {
        if (uris == null)
        {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WithHash(string algorithm, string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WithHash256(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WithHashSha384(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WithHashSha512(string hash)
    {
    ...
    public ScriptSourceDirectiveBuilder WithHashTagHelper()
    {
        SourceBuilders.Add(
            ...
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.ScriptSourceDirectiveBuilder.{nameof(WithHashTagHelper)}");
        return this;
    }
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder UnsafeInline()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder UnsafeHashes()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder UnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WasmUnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder StrictDynamic()
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder InlineSpeculationRules()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceDirectiveBuilder WithNonce()
    {
        // The format parameter will be replaced with the nonce for each request
        SourceBuilders.Add(
            ctx => $"'nonce-{ctx.GetNonce()}'",
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.ScriptSourceDirectiveBuilder.{nameof(WithNonce)}");
        return this;
    }
