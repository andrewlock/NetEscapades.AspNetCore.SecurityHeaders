...
public partial class StyleSourceElemDirectiveBuilder
{
    /// <summary>
    /// Block the resource (Refers to the empty set; that is, no URLs match)
    /// </summary>
    /// <returns>The builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder None()
    {
        BlockResources = true;
        return this;
    }
    ...
    public StyleSourceElemDirectiveBuilder Self()
    {
        Sources.Add("'self'");
        return this;
    }
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder From(string uri)
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder From(System.Collections.Generic.IEnumerable<string> uris)
    {
        if (uris == null)
        {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder WithHash(string algorithm, string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder WithHash256(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder WithHashSha384(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder WithHashSha512(string hash)
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder UnsafeInline()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder UnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public StyleSourceElemDirectiveBuilder WithNonce()
    {
        // The format parameter will be replaced with the nonce for each request
        SourceBuilders.Add(
            ctx => $"'nonce-{ctx.GetNonce()}'",
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.StyleSourceElemDirectiveBuilder.{nameof(WithNonce)}");
        return this;
    }
