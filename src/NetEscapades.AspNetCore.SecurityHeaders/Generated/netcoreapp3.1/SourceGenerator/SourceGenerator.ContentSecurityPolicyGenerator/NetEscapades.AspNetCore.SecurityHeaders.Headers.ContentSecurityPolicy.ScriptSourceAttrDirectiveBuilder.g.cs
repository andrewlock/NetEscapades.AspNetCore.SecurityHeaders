...
public partial class ScriptSourceAttrDirectiveBuilder
{
    /// <summary>
    /// Block the resource (Refers to the empty set; that is, no URLs match)
    /// </summary>
    /// <returns>The builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder None()
    {
        BlockResources = true;
        return this;
    }
    ...
    public ScriptSourceAttrDirectiveBuilder WithHash(string algorithm, string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder WithHash256(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder WithHashSha384(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder WithHashSha512(string hash)
    {
    ...
    public ScriptSourceAttrDirectiveBuilder WithHashTagHelper()
    {
        SourceBuilders.Add(
            ...
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.ScriptSourceAttrDirectiveBuilder.{nameof(WithHashTagHelper)}");
        return this;
    }
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder UnsafeInline()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceAttrDirectiveBuilder UnsafeHashes()
    {
