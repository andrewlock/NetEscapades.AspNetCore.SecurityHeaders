...
public partial class ScriptSourceElemDirectiveBuilder
{
    /// <summary>
    /// Block the resource (Refers to the empty set; that is, no URLs match)
    /// </summary>
    /// <returns>The builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder None()
    {
        BlockResources = true;
        return this;
    }
    ...
    public ScriptSourceElemDirectiveBuilder Self()
    {
        Sources.Add("'self'");
        return this;
    }
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder From(string uri)
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder From(System.Collections.Generic.IEnumerable<string> uris)
    {
        if (uris == null)
        {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WithHash(string algorithm, string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WithHash256(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WithHashSha384(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WithHashSha512(string hash)
    {
    ...
    public ScriptSourceElemDirectiveBuilder WithHashTagHelper()
    {
        SourceBuilders.Add(
            ...
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.ScriptSourceElemDirectiveBuilder.{nameof(WithHashTagHelper)}");
        return this;
    }
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder UnsafeInline()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder UnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WasmUnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder StrictDynamic()
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder InlineSpeculationRules()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public ScriptSourceElemDirectiveBuilder WithNonce()
    {
        // The format parameter will be replaced with the nonce for each request
        SourceBuilders.Add(
            ctx => $"'nonce-{ctx.GetNonce()}'",
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.ScriptSourceElemDirectiveBuilder.{nameof(WithNonce)}");
        return this;
    }
