...
public partial class DefaultSourceDirectiveBuilder
{
    /// <summary>
    /// Block the resource (Refers to the empty set; that is, no URLs match)
    /// </summary>
    /// <returns>The builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder None()
    {
        BlockResources = true;
        return this;
    }
    ...
    public DefaultSourceDirectiveBuilder Self()
    {
        Sources.Add("'self'");
        return this;
    }
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder From(string uri)
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder From(System.Collections.Generic.IEnumerable<string> uris)
    {
        if (uris == null)
        {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WithHash(string algorithm, string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WithHash256(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WithHashSha384(string hash)
    {
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WithHashSha512(string hash)
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder UnsafeInline()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder UnsafeHashes()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder UnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WasmUnsafeEval()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder StrictDynamic()
    {
    ...
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder InlineSpeculationRules()
    {
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder WithNonce()
    {
        // The format parameter will be replaced with the nonce for each request
        SourceBuilders.Add(
            ctx => $"'nonce-{ctx.GetNonce()}'",
            $"NetEscapades.AspNetCore.SecurityHeaders.Headers.ContentSecurityPolicy.DefaultSourceDirectiveBuilder.{nameof(WithNonce)}");
        return this;
    }
    ...
    /// </summary>
    /// <returns>The CSP builder for method chaining</returns>
    public DefaultSourceDirectiveBuilder ReportSample()
    {
