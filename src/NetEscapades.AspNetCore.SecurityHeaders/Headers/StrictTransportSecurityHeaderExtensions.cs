...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class StrictTransportSecurityHeaderExtensions
    {
        ...
        {
            return policies.AddStrictTransportSecurity(maxAgeInSeconds, includeSubdomains: false, preload: false, _excludedHosts);
        }
        ...
        {
            return policies.AddStrictTransportSecurity(maxAgeInSeconds, includeSubdomains: true, preload: false, _excludedHosts);
        }
